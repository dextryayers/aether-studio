  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-background border-b border-border/50">
      ...
      <div className="max-w-5xl space-y-12 z-10 relative">
        <h1 className="sr-only">{t("hero.subtitle")} - {t("common.creativeStudio")}</h1>
        <div className="space-y-4">
          ...
          <motion.div 
            ...
            className="text-5xl md:text-[64px] display-bold text-foreground leading-[0.85] tracking-tighter"
            aria-hidden="true"
          >
            {t("hero.we")} <span className="italic font-light opacity-50">{t("hero.titleItalic")}</span> <br />
