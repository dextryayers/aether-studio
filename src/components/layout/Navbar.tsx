...
import { Menu, X, Home, Briefcase, Cpu, User, Mail, MessageSquare, Instagram, Twitter, Linkedin, Github, FileText, Rocket, PanelLeftClose, PanelLeftOpen } from "lucide-react"
...
export function Navbar({ sidebarOpen = true, onToggleSidebar }: { sidebarOpen?: boolean; onToggleSidebar?: () => void }) {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {!sidebarOpen && (
          <motion.button
            ...
            className="hidden lg:flex fixed left-4 top-4 z-50 items-center justify-center w-10 h-10 bg-card border border-border hover:bg-primary hover:text-primary-foreground transition-colors"
      ...
      <motion.aside
        ...
        className="hidden lg:flex fixed left-0 top-0 bottom-0 w-72 bg-card border-r border-border flex-col p-8 z-50 transition-colors duration-300"
      >
        <div className="flex items-center justify-between mb-12">
          <Link to="/" className="flex items-center gap-3 font-extrabold text-2xl tracking-tighter">
            ...
            <span className="uppercase tracking-tight">Haniplabs</span>
          </Link>
          <button
            onClick={onToggleSidebar}
        ...
        <div className="pt-8 border-t border-border space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="inline-flex items-center gap-2 mt-2">
              ...
              <span className="text-[9px] font-mono text-muted-foreground uppercase tracking-tight">{t("ui.visitorIp")}: {userIp}</span>
            </div>
          </div>
        </div>
      </motion.aside>
