...
export function AIChat() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { role: "model", content: `${t("ui.chatError")} (${errorMsg})` }])
    } finally {
      setIsLoading(false)
    }
  }
          ...
          >
            <div className="p-4 border-b border-border flex items-center justify-between bg-primary/5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.2em]">{t("ui.aetherAssistant")}</span>
              </div>
              <Button 
