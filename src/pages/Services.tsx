      ...
      <div className="page-fade-in pb-32">
        ...
        <section className="pt-40 lg:pt-60 pb-32 px-6 max-w-7xl mx-auto border-b border-border/50">
          <div className="max-w-5xl space-y-12">
             ...
             <motion.h1 
               ...
               className="text-6xl md:text-[100px] display-bold leading-[0.75] tracking-tighter uppercase"
             >
               {t("services.title")} <br /> 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
              <div className="space-y-24">
                <div className="space-y-8">
                  ...
                  <h2 className="text-4xl md:text-7xl display-bold leading-[0.9] uppercase tracking-tighter">{t("services.way")}</h2>
        ...
        <section className="py-40 px-6 max-w-7xl mx-auto border-b border-border/50">
           <div className="flex flex-wrap justify-center gap-x-12 gap-y-8">
               {(t("services.tags") as unknown as string[]).map((tag: string) => (
        ...
        <section className="py-40 px-6 text-center">
           <div className="max-w-4xl mx-auto space-y-16">
             <h3 className="text-3xl md:text-6xl display-bold uppercase tracking-tighter">{t("services.elevate")}</h3>
