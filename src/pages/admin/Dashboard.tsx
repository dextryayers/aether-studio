  ...
  return (
    <div className="space-y-6 lg:space-y-10">
            ...
            <div className="relative space-y-3 lg:space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {loaded ? (
                    <span className="text-xl lg:text-2xl font-black tracking-tighter text-foreground tabular-nums">
                      {card.value}
                    </span>
                  ) : (
              ...
              <div>
                <p className="text-[10px] lg:text-xs font-bold uppercase tracking-widest text-muted-foreground group-hover:text-primary transition-colors">
                  {card.label}
                </p>
      ...
      <div className="border-t border-border/30 pt-6 lg:pt-8">
        <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground mb-3 lg:mb-4">
          Quick Actions
        </p>
