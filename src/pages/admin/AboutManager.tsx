    ...
    <div className="space-y-5 lg:space-y-8">
      ...
      <div className="border border-border/60 bg-card p-4 lg:p-6 space-y-4 lg:space-y-6">
        <div className="space-y-1.5 lg:space-y-2">
          <label className="flex items-center gap-2 text-[8px] lg:text-[9px] font-bold uppercase tracking-widest text-muted-foreground">
          ...
          <textarea value={form.content_en} onChange={(e) => setForm({ ...form, content_en: e.target.value })}
            className="w-full h-28 lg:h-40 bg-background border border-border px-3 lg:px-4 py-2 lg:py-3 text-sm text-foreground outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/20 transition-all resize-none" placeholder="Write your biography in English..." />
        </div>
        <div className="space-y-1.5 lg:space-y-2">
          <label className="flex items-center gap-2 text-[8px] lg:text-[9px] font-bold uppercase tracking-widest text-muted-foreground">
            <span className="w-3.5 h-3.5 lg:w-4 lg:h-4 rounded-full bg-primary/20 flex items-center justify-center">
          ...
          <textarea value={form.content_id} onChange={(e) => setForm({ ...form, content_id: e.target.value })}
            className="w-full h-28 lg:h-40 bg-background border border-border px-3 lg:px-4 py-2 lg:py-3 text-sm text-foreground outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/20 transition-all resize-none" placeholder="Tulis biografi Anda dalam Bahasa Indonesia..." />
        </div>
