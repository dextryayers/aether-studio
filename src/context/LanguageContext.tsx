...
const translations: Record<Language, any> = {
  en: {
    ...
    home: {
      ...
      diag1Label: "Neural Load",
      diag1Value: "Optimal",
      diag2Label: "Uptime Protocol",
      diag2Value: "99.98% / 0.02ms",
      diag3Label: "Current Sector",
      diag3Value: "Creative Recon",
      diag4Label: "Signal Fidelity",
      diag4Value: "High-Freq",
      timelineTitle: "Timeline",
      timeline: [
        { year: "2021 - 2022", title: "Foundation", event: "Immersed in Linux systems, mastering the command line, shell scripting, and navigating the open-source ecosystem with confidence." },
        { year: "2023", title: "Programming Development", event: "Built a solid foundation in web engineering - semantic HTML, advanced CSS layouts, and core JavaScript concepts through hands-on projects." },
        { year: "2024 - 2025", title: "Cyber Security", event: "Entered the cybersecurity realm - practiced penetration testing, bug bounty hunting, and studied defensive security infrastructure." },
        { year: "2026", title: "Software Development & Experience", event: "Engineering custom security tools and full-stack software solutions designed for real-world deployment and reliability." },
      ],
      aboutTitle: "About Me",
      aboutDesc: "I'm a self-taught engineer driven by curiosity. I breathe Linux, speak JavaScript, and chase the thrill of breaking and securing systems. I build things that work—clean, reliable, and purposeful.",
    },
    work: {
      selected: "CURATED",
      works: "PROJECTS",
      ...
      volume: "VOLUME",
      ctaDesc: "Every project begins with a conversation. Let's explore what we can build together.",
    ...
    services: {
      ...
      tags: ["UI/UX DESIGN", "CUSTOM WEB DEVELOPMENT", "MOBILE INFRASTRUCTURE", "CREATIVE STRATEGY", "NEURAL INTEGRATION", "BRAND SYNTHESIS"],
    },
    contact: {
      ...
      form: {
        ...
        placeholderFirst: "E.g. John",
        placeholderLast: "E.g. Doe",
    ...
    about: {
      ...
      systemManifesto: "System Manifesto",
      version: "Version 4.0.21",
      operationalValues: "Operational Values",
      valuesDesc: "Strategic principles engineered for high-fidelity execution and absolute precision.",
      archiveLabel: "AETHER STUDIO ARCHIVE v.4.0",
    },
    servicesSection: {
      title: "CORE",
      italic: "SYSTEMS",
    ...
    ui: {
      ...
      settings: "Settings",
      cookieDesc: "I'm Hanif, the developer of this website. This site is built with high precision and uses cookies to ensure a fluid, premium interaction.",
      askAI: "Ask Aether AI",
      aetherAssistant: "Aether Assistant",
      typeMessage: "Type a message...",
      chatEmpty: "I am the synaptic pulse of Aether. Ask me about our vision, branding, or the digital future.",
      chatError: "Apologies, my synaptic link was momentarily interrupted. Please try asking again.",
      loading: "Loading",
      loadingBrand: "AETHER STUDIO",
      poweredBy: "POWERED BY HANIIPP.SPACE",
      copyright: "ARCHIVE // HANIIP",
      visitorIp: "VISITOR IP",
      creativeProtocol: "Creative Protocol v4.0",
  ...
  id: {
    ...
    common: {
      ...
      digitalFuture: "Masa Depan Digital Strategis",
      categories: {
        all: "Semua",
        product: "Produk",
        brand: "Merek",
    ...
    home: {
      ...
      diag1Label: "Beban Neural",
      diag1Value: "Optimal",
      diag2Label: "Protokol Uptime",
      diag2Value: "99.98% / 0.02ms",
      diag3Label: "Sektor Saat Ini",
      diag3Value: "Recon Kreatif",
      diag4Label: "Fidelitas Sinyal",
      diag4Value: "Frekuensi Tinggi",
      timelineTitle: "Garis Waktu",
      timeline: [
        { year: "2021 - 2022", title: "Pondasi", event: "Mendalami sistem Linux, menguasai command-line, shell scripting, dan menjelajahi ekosistem open-source secara langsung." },
        { year: "2023", title: "Perkembangan Pemrograman", event: "Membangun pondasi web engineering - HTML semantik, tata letak CSS tingkat lanjut, dan konsep inti JavaScript lewat proyek nyata." },
        { year: "2024 - 2025", title: "Cyber Security", event: "Memasuki dunia keamanan siber - berlatih penetration testing, bug bounty hunting, dan mempelajari infrastruktur pertahanan digital." },
        { year: "2026", title: "Development Software & Experience", event: "Mengembangkan tools keamanan kustom dan solusi software full-stack yang dirancang untuk implementasi dunia nyata dan keandalan tinggi." },
      ],
      aboutTitle: "Tentang Saya",
      aboutDesc: "Seorang engineer otodidak yang didorong rasa ingin tahu. Bernapas dengan Linux, berbicara dengan JavaScript, dan mengejar sensasi menembus serta mengamankan sistem. Saya membangun hal-hal yang bekerja - bersih, andal, dan penuh tujuan.",
    },
    work: {
      selected: "KURASI",
      works: "PROYEK",
      ...
      volume: "VOLUME",
      ctaDesc: "Setiap proyek dimulai dari percakapan. Mari kita jelajahi apa yang bisa kita bangun bersama.",
    ...
    services: {
      ...
      tags: ["DESAIN UI/UX", "PENGEMBANGAN WEB KUSTOM", "INFRASTRUKTUR MOBILE", "STRATEGI KREATIF", "INTEGRASI NEURAL", "SINTESIS MEREK"],
    },
    contact: {
      ...
      form: {
        ...
        placeholderFirst: "Cth. John",
        placeholderLast: "Cth. Doe",
        placeholderEmail: "example@example.com",
        options: {
          fullProduct: "Produk Penuh",
    ...
    about: {
      ...
      systemManifesto: "Manifesto Sistem",
      version: "Versi 4.0.21",
      operationalValues: "Nilai Operasional",
      valuesDesc: "Prinsip strategis yang dirancang untuk eksekusi fidelitas tinggi dan presisi mutlak.",
      archiveLabel: "ARSIP AETHER STUDIO v.4.0",
    },
    servicesSection: {
      title: "SISTEM",
      italic: "INTI",
    ...
    chat: {
      ...
      suggestions: [
        ...
        "Buat konsep untuk lab visual AI."
      ],
    ...
    ui: {
      ...
      settings: "Pengaturan",
      cookieDesc: "Saya Hanif, pengembang website ini. Situs ini dirancang dengan presisi tinggi dan menggunakan cookie untuk memastikan interaksi yang lancar dan berkualitas.",
      askAI: "Tanya Aether AI",
      aetherAssistant: "Asisten Aether",
      typeMessage: "Ketik pesan...",
      chatEmpty: "Saya adalah denyut sinaptik Aether. Tanyakan tentang visi, branding, atau masa depan digital.",
      chatError: "Maaf, tautan sinaptik saya terputus sementara. Silakan coba lagi.",
      loading: "Memuat",
      loadingBrand: "STUDIO AETHER",
      poweredBy: "DIDUKUNG OLEH HANIIPP.SPACE",
      copyright: "ARSIP // HANIIP",
      visitorIp: "IP PENGUNJUNG",
      creativeProtocol: "Protokol Kreatif v4.0",
